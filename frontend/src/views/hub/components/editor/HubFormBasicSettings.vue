...
const emit = defineEmits<{
    'update:basic-data': [value: string]
}>();

const formRef = ref<FormInst | null>(null);

const formValue = reactive({
    size: props.generalSetting.size,
    color: props.generalSetting.color,
    layout: props.generalSetting.layout,
});

const rules: FormRules = {
};

watch(formValue, () => emit('update:basic-data', JSON.stringify({ 'size': formValue.size.toString(), 'color': formValue.color, 'layout': formValue.layout })));
