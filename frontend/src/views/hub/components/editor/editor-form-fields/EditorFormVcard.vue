...
const formValue = reactive({
    data: {
        type: 'vcard',
        name: props.currentValue.data.name || '',
        surname: props.currentValue.data.surname || '',
        tnumber: props.currentValue.data.tnumber || '',
        mnumber: props.currentValue.data.mnumber || '',
        email: props.currentValue.data.email || '',
        url: props.currentValue.data.url || '',
        company: props.currentValue.data.company || '',
        jobtitle: props.currentValue.data.jobtitle || '',
        fax: props.currentValue.data.fax || '',
        address: props.currentValue.data.address || '',
        city: props.currentValue.data.city || '',
        postcode: props.currentValue.data.postcode || '',
        country: props.currentValue.data.country || '',
    },
});
